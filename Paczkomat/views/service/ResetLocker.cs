...
public class ResetLocker: BaseForm
{
    private readonly Label _mainText;
    private readonly Button _receiveButton;
    private readonly Button _goBackButton;
    
    public ResetLocker(int x, int y) : base("Zresetuj skrytkę")
    {
        // Add a welcome label
        _mainText = new Label();
        _mainText.Text = $"Chcesz zresetować skrytkę na {x+1} x {y+1}!";
    ...
    {
        Paczkomat.Instance.RemovePackage(x, y);
